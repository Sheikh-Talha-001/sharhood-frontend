...
export function PromoBanner() {
  return (
    <section className="py-24 px-6">
      ...
      >
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-brand-yellow/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="flex-1 relative order-2 lg:order-1 w-full">
          ...
          >
             ...
             <div className="relative mx-auto w-[90%] max-w-[450px] aspect-[1.6/1]">
                <div className="w-full h-full bg-brand-black rounded-t-3xl p-2 border-4 border-gray-800 shadow-2xl relative overflow-hidden">
                   <div className="w-full h-full bg-white rounded-t-2xl overflow-hidden p-4 relative flex items-center justify-center">
                      <div className="text-center">
                         <div className="w-12 h-12 bg-brand-orange rounded-xl mx-auto mb-3 flex items-center justify-center">
        ...
        <div className="flex-1 z-10 text-center lg:text-left order-1 lg:order-2">
          ...
          <button className="bg-brand-black text-white px-8 py-4 rounded-full font-bold text-base uppercase tracking-widest hover:scale-105 active:scale-95 transition-transform flex items-center gap-3 mx-auto lg:mx-0 shadow-lg group">
            Explore Marketplace
            <div className="w-8 h-8 bg-brand-orange rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
