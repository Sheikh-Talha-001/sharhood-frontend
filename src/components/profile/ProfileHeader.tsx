  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-start md:items-center w-full mb-10">
      ...
      <div className="relative shrink-0">
        <div className="size-24 md:size-32 rounded-3xl overflow-hidden shadow-sm border border-gray-100 bg-brand-yellow flex items-center justify-center">
          {user?.avatar ? (
      ...
      <div className="flex w-full md:w-auto gap-4 mt-4 md:mt-0">
        ...
        <button type="button" className="flex-1 md:flex-none px-6 py-3 rounded-full bg-green-500 text-white font-bold text-sm hover:bg-green-600 transition-colors shadow-sm shadow-green-500/20 flex items-center justify-center gap-2">
          <svg className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
          Share Profile
        </button>
      </div>
    </div>
